...
| -------------------------- | ------------ | --------------- | --------------------------------------------------- |
| [2.0.8](CHANGELOG.md#v208) | 2025-05-29 | feat: Implement temporary file creation for payload and enhance command execution flow | [Download](releases/bas-service-2.0.8.vsix) |
| [2.0.7](CHANGELOG.md#v207) | 2025-05-28 | style: Update PresetItem component styles for improved layout and interaction | [Download](releases/archive/bas-service-2.0.7.vsix) |
